...
public class ShadowMapEntityRenderer {
	 ...
	 */
	protected void render(Map<TexuredModel, List<Entity>> entities) {
	...
	private void prepareInstance(Entity entity) {
		Matrix4f modelMatrix = Maths.createTranformationMatrix(entity.getPosition(),entity.getRotx(),entity.getRoty(),entity.getRotz(),entity.getScale());
